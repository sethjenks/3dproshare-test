...
class FP_Grid { 
	...
	public function fp_rows( $atts, $content ) { 
		...
		if ( $horizontal_align == 'right' ) { $horizontal_align = 'align-right '; } 
		elseif ( $horizontal_align == 'left' ) { $horizontal_align = 'align-left '; } 
		elseif ( $horizontal_align == 'center' ) { $horizontal_align = 'align-center '; } 
		elseif ( $horizontal_align == 'justify' ) { $horizontal_align = 'align-justify '; } 
		elseif ( $horizontal_align == 'spaced' ) { $horizontal_align = 'align-spaced '; }
		else { $horizontal_align = ''; } 

		if ( $vertical_align == 'top' ) { $vertical_align = 'align-top '; } 
		elseif ( $vertical_align == 'middle' ) { $vertical_align = 'align-middle '; } 
		elseif ( $vertical_align == 'bottom' ) { $vertical_align = 'align-bottom '; } 
		elseif ( $vertical_align == 'stretch' ) { $vertical_align = 'align-stretch '; } 
		else { $vertical_align = ''; } 
		...
		$bool_options = array( 
			...
			array( 'bool' => $medium_unstack, 'class' => 'medium-unstack ' ), 
			array( 'bool' => $large_unstack, 'class' => 'large-unstack ' ), 
		 );
	...
	public function fp_columns( $atts, $content ){ 
		...
		if ( $vertical_align == 'top' ) { $vertical_align = 'align-self-top '; } 
		elseif ( $vertical_align == 'middle' ) { $vertical_align = 'align-self-middle '; } 
		elseif ( $vertical_align == 'bottom' ) { $vertical_align = 'align-self-bottom '; } 
		elseif ( $vertical_align == 'stretch' ) { $vertical_align = 'align-self-stretch '; } 
		else { $vertical_align = ''; } 
		...
		$bool_options = array( 
			array( 'bool' => $shrink, 'class' => 'shrink ' ), 
			array( 'bool' => $medium_expand, 'class' => 'medium-expand ' ), 
			array( 'bool' => $large_expand, 'class' => 'large-expand ' )
		 );
