...
(function() {
    tinymce.PluginManager.add('fp_foundation_4_button', function( editor, url ) {
        editor.addButton( 'fp_foundation_4_button', {
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {
                                ...
                                if( e.data.offsets === true ) { fp_column_classes.push( "small_offset='' large_offset=''" ); }
                                if( e.data.source_ordering === true ) { fp_column_classes.push( "push='' pull=''" ); } 
                                if( e.data.block_grids === true ) { fp_row_classes.push( "small_up='' large_up=''" ); } 
                                ...
                                for (var i = 0; i < e.data.columns; i++) {
                                        var columns = i + 1;
                                        rawTemplate += "[fp-columns small='' large='' {{column_classes}}][/fp-columns]<br>";                                    
                                    } 
                        ...
                        editor.windowManager.open( {
                            ...
                            body: [{
                                ...
                                'values': [
                                    ...
                                    {text: fp_foundation_assistant_localized_script.hide_portrait, value: "hide_portrait='true'"},
                                    {text: fp_foundation_assistant_localized_script.show_landscape, value: "show_landscape='true'"},
                                    {text: fp_foundation_assistant_localized_script.hide_landscape, value: "hide_landscape='true'"}
                                ]
                            }],
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {
                                ...
                                var rawTemplate = "[fp-interchange default='' small='' large='']"; 
