...
(function() {
    tinymce.PluginManager.add('fp_foundation_6_button', function( editor, url ) {
        editor.addButton( 'fp_foundation_6_button', {
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            body: [{
                                ...
                                type: 'checkbox',
                                name: 'expanded',
                                text: fp_foundation_assistant_localized_script.expanded,   
                                classes: 'fp-checkbox'                 
                            },{
                                type: 'checkbox',
                                name: 'offsets',
                            ...
                            onsubmit: function( e ) {
                                ...
                                if(e.data.expanded === true) { fp_row_classes.push( "expanded='true'"); }
